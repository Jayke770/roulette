                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                {/* Mobile menu button*/}
                                <Disclosure.Button className="inline-flex transition-all items-center justify-center rounded-md p-2 text-gray-400 hover:bg-zinc-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-inset focus:ring-teamdao-primary">
                                            ...
                                            <Link key={item.name} passHref href={item.href}>
                                                <a
                                                    className={classNames(
                                                        item.current ? 'bg-zinc-900 text-white' : 'text-gray-300 hover:bg-zinc-800 hover:text-white',
                            ...
                            {navigation.map((item) => (
                                <Link key={item.name} passHref href={item.href}>
                                    <Disclosure.Button
                                        as="a"
                                        className={classNames(
                                            item.current ? 'bg-zinc-800 text-white' : 'text-gray-300 hover:bg-zinc-800 hover:text-white',
